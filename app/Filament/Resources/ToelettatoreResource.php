...
use App\Filament\Resources\ToelettatoreResource\Pages;
use App\Models\User;
use Filament\Forms;
...
class ToelettatoreResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Toelettatore';

    protected static ?string $pluralModelLabel = 'Toelettatori';

    protected static ?string $slug = 'toelettatori';

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('role', 'toelettatore');
    }
    ...
    {
        return [
            'index' => Pages\ListToelettatori::route('/'),
            'create' => Pages\CreateToelettatore::route('/create'),
            'edit' => Pages\EditToelettatore::route('/{record}/edit'),
        ];
    }
} 