<x-main-layout>
        ...
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                    {{ __('professional.details_title') }}
                </h2>
                <p class="text-gray-600 dark:text-gray-400">
                    {{ __('professional.details_subtitle') }}
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8 p-6 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg">
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-orange-600 dark:text-orange-400 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <div>
                                <h3 class="text-lg font-semibold text-orange-800 dark:text-orange-200 mb-2">
                                    {{ __('professional.why_details_title') }}
                                </h3>
                                <p class="text-orange-700 dark:text-orange-300 text-sm leading-relaxed">
                                    {{ __('professional.why_details_description') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('professional.details.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea id="descrizione" 
                                      ...
                                      rows="4"
                                      class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-orange-500 focus:ring-orange-500"
                                      placeholder="{{ __('professional.description_placeholder') }}">{{ old('descrizione') }}</textarea>
                            @error('descrizione')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                                    ...
                                    <div id="mainPhotoDropZone" 
                                        ...
                                        <div class="flex flex-col items-center space-y-2">
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-300" id="mainPhotoText">
                                                {{ __('professional.drag_drop_main_photo') }}
                                            </p>
    ...
    <script>
        ...
        mainPhotoDropZone.addEventListener('dragleave', (e) => {
            ...
            document.getElementById('mainPhotoText').textContent = '{{ __('professional.drag_drop_main_photo') }}';
        });
