...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (DB::connection()->getDriverName() === 'pgsql') {
            // Per PostgreSQL, dobbiamo modificare il valore di default
            DB::statement("ALTER TABLE users ALTER COLUMN role SET DEFAULT 'associazione'");
            
            // Aggiorna il vincolo di controllo per includere 'admin'
    ...
    {
        if (DB::connection()->getDriverName() === 'pgsql') {
            // Ripristina il valore di default originale
